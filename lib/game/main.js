...
.defines(function(){"use strict";
    ...
    var MyGame = ig.Game.extend({
        ...
        scoreboard: null, // entity that draws names, scores, etc.
        ...
        update: function() {
            ...
            // Spawn scoreboard if score-key pressed.
            if(ig.input.pressed('SCORE')) {
                this.scoreboard = this.spawnEntity(EntityScoreboard, 0, 0);
            }
            // Remove scoreboard if score-key released.
            else if(ig.input.released('SCORE')) {
