...
.defines(function(){"use strict";
    ...
    var MyGame = ig.Game.extend({
        ...
        handle_snapshot: function(snapshot) {
            ...
            for(var type in snapshot) {

                // Loop through entities.
                for(var name in snapshot[type]) {
                    ...
                    if(entity) {
                        ...
                        // Update entity.
                        entity = ig.merge(entity, snapshot[type][name]);
                    ...
                    // Entity not found.
                        ...
                        // Spawn entity.
                        var x = snapshot[type][name].pos.x;
                        var y = snapshot[type][name].pos.y;
