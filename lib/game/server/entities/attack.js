...
.requires('game.shared.entities.attack', 'game.server.collision-map')
.defines(function() {
    ...
    EntityAttack.inject({
        ...
        init: function(x, y, settings) {
            ...
            ig.game.log(this.attacker.name + ' attacks...');
            ...
            this.end_point.x = start_x + Math.cos(this.angle) * distance;
            this.end_point.y = start_y + Math.sin(this.angle) * distance;
